...
var InitGenres = function () {
    ...
    const FETCH_API_ENPOINT = APP_URL + '/api/genres'; // API endpoint for fetching roles
    const CREATE_API_ENPOINT = APP_URL + '/api/genres'; // API endpoint for creating
    const UPDATE_API_ENPOINT = APP_URL + '/api/genres/update'; // API endpoint for updating
    const DELETE_API_ENDPOINT = APP_URL + '/api/genres/delete'; // API endpoint for deleting
