...
var InitProduct = function () {
    ...
    const FETCH_API_ENPOINT = APP_URL + '/api/stock'; // API endpoint for fetching roles
    const CREATE_API_ENPOINT = APP_URL + '/api/stock'; // API endpoint for creating
    const DELETE_API_ENDPOINT = APP_URL + '/api/stock/delete'; // API endpoint for deleting
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        let stockType = '';
                        if (data == 'IN') {
                            stockType = `<span class="text-success fw-bolder">IN</span>`;
                        } else if (data == 'OUT') {
                            stockType = `<span class="text-danger fw-bolder">OUT</span>`;
                        }
                        return stockType;
                    },
                },
