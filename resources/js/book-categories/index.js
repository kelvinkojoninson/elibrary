...
var InitCategories = function () {
    ...
    const FETCH_API_ENPOINT = APP_URL + '/api/book-categories'; // API endpoint for fetching roles
    const CREATE_API_ENPOINT = APP_URL + '/api/book-categories'; // API endpoint for creating
    const UPDATE_API_ENPOINT = APP_URL + '/api/book-categories/update'; // API endpoint for updating
    const DELETE_API_ENDPOINT = APP_URL + '/api/book-categories/delete'; // API endpoint for deleting
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        if (permissions.modUpdate == 1) {
                            actions += `<span style="cursor:pointer" class="text-info me-3" data-kt-table-filter="update_row">
                                        Edit
                                    </span>`;
                        }
