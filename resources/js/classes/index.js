...
var InitClasses = function () {
    ...
    const FETCH_API_ENPOINT = APP_URL + '/api/classes'; // API endpoint for fetching roles
    const CREATE_API_ENPOINT = APP_URL + '/api/classes'; // API endpoint for creating
    const UPDATE_API_ENPOINT = APP_URL + '/api/classes/update'; // API endpoint for updating
    const DELETE_API_ENDPOINT = APP_URL + '/api/classes/delete'; // API endpoint for deleting
