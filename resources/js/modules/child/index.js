"use strict";
/**
InitChildModule is a module that handles the initialization and functionality of a module children management CRUD.
...
var InitChildModule = function () {
    ...
    const FETCH_API_ENPOINT = APP_URL + '/api/modules/children'; // API endpoint for fetching
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        return Boolean(data.parentName) ? `<div class="badge badge-info">${data.parentName}</div>` : '';
                    },
                },
                {
    ...
    const handleUpdateRows = () => {
        ...
        buttons.forEach(button => {
            button.addEventListener('click', function (e) {
                ...
                $("#update-parentMod").val(data.pmodID).trigger('change');
