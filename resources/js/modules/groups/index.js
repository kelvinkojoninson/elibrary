"use strict";
/**
InitModuleGroup is a module that handles the initialization and functionality of a module group management CRUD.
...
var InitModuleGroup = function () {
    ...
    const FETCH_API_ENPOINT = APP_URL + '/api/modules/groups'; // API endpoint for fetching
    const CREATE_API_ENPOINT = APP_URL + '/api/modules/add-group'; // API endpoint for creating 
    const UPDATE_API_ENPOINT = APP_URL + '/api/modules/update-group'; // API endpoint for updating
    const DELETE_API_ENDPOINT = APP_URL + '/api/modules/delete-group'; // API endpoint for deleting 
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        return data == 1 ? `<div class="bg-success fw-bolder">Active</div>` : `<div class="bg-danger fw-bolder">Inactive</div>`;
                    },
                },
                {
                    data: null,
    ...
    const handleUpdateRows = () => {
        ...
        buttons.forEach(button => {
            button.addEventListener('click', function (e) {
                ...
                data.status == 1 ? document.getElementById("update-status").checked = true : document.getElementById("update-status").checked = false;
            })
        });
    }
