...
var InitShelves = function () {
    ...
    const FETCH_API_ENPOINT = APP_URL + '/api/shelves'; // API endpoint for fetching roles
    const CREATE_API_ENPOINT = APP_URL + '/api/shelves'; // API endpoint for creating
    const UPDATE_API_ENPOINT = APP_URL + '/api/shelves/update'; // API endpoint for updating
    const DELETE_API_ENDPOINT = APP_URL + '/api/shelves/delete'; // API endpoint for deleting
