                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="tg-innerbannercontent">
                        ...
                        <ol class="tg-breadcrumb">
                            ...
                            <li class="tg-active">Downloads</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="tg-postbook">
                                ...
                                <div class="tg-postbookcontent">
                                    ...
                                    <a class="tg-btn tg-active tg-btn-lg"
                                        href="{{ route('delete.download', ['id' => $book->book_id]) }}">
                                        <em>Remove</em>
                                    </a>
                                    <a class="tg-btn tg-btnaddtowishlist" target="_blank" download="{{ $book->title }}"
                                        href="{{ $book->filepath }}">
                                        <em>Download</em>
                                    </a>
                                </div>
